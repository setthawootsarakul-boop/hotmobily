    ...
    <div class="container pb-4 border-bottom border-secondary">
      <div class="row gy-4 align-items-stretch">
        ...
        <div class="col-md-4 text-center text-md-start footer-company">
          ...
          <p class="mb-2">
            ที่อยู่ : 23/34-35 อาคารโครงการเดอะโฟร์ม หัวลำโพง อาคาร A ห้องเลขที่ 303 ชั้นที่ 3<br>
            แขวงตลาดน้อย เขตสัมพันธวงศ์ กรุงเทพมหานคร 10100
          </p>
          <p class="fw-semibold mt-2">
            โทร : <a href="tel:0646045614" class="text-light text-decoration-none">064-604-5614</a>
          </p>
        </div>
        ...
        <div class="col-md-4 text-center text-md-start footer-social">
          ...
          <p>Line : <span class="fw-semibold">hotstrapthai</span></p>
...
<div class="footer-links-section py-4">
      <div class="container text-center">
        <div class="footer-links d-flex flex-wrap justify-content-center gap-3 text-secondary">
          <a href="#">สินค้าทั้งหมด</a> <span>|</span>
          <a href="#">วิธีการสั่งสินค้า</a> <span>|</span>
          <a href="#">วิธีการชำระเงิน</a> <span>|</span>
          <a href="#">วิธีการออกแบบ</a> <span>|</span>
          <a href="#">ระยะเวลาการจัดส่ง</a> <span>|</span>
          
          {{-- <div class="w-100 d-none d-lg-block"></div>  --}}

          <a href="#">แจ้งชำระเงิน</a> <span>|</span>
          <a href="#">อุปกรณ์เสริม</a> <span>|</span>
          <a href="#">แคตตาล็อก</a> <span>|</span>
          <a href="#">ติดต่อเรา</a> <span>|</span>
          <a href="#">คำถามที่พบบ่อย</a> <span>|</span>
