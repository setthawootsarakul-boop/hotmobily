            ...
            <div class="design-text-only">
                ...
                <div class="design-flex-container">
                    ...
                    <div class="design-qr-box">
                        <img src="{{ asset('images/line-qr.png') }}" alt="Line QR Code">
                    </div>
                </div>
                ...
                <div class="design-template-section">
                    ...
                    <div class="template-image-wrapper">
                        <img src="{{ asset('images/image-template.png') }}" alt="Template Preview">
                    </div>
                </div>
                ...
                <div class="design-placing-section">
                    ...
                    <div class="placing-image-wrapper">
                        <img src="{{ asset('images/placing.png') }}" alt="Placing Design">
                    </div>
                </div>
                ...
                <div class="diecut-placing-section">
                    ...
                    <div class="diecut-image-wrapper">
                        <img src="{{ asset('images/diecut.png') }}" alt="Diecut Guide">
                    </div>
                </div>
                ...
                <div class="screen-section">
                    ...
                    <div class="screen-image-wrapper">
                        <img src="{{ asset('images/screen1.png') }}" alt="Screen White 1">
                        <img src="{{ asset('images/screen2.png') }}" alt="Screen White 2">
                    </div>
                </div>
                ...
                <div class="holesloops-section">
                    ...
                    <div class="screen-image-wrapper">
                        <img src="{{ asset('images/holesloops.png') }}" alt="Holes and Loops Guide">
                    </div>
                </div>
...
<div class="faq-section">
    <div class="faq-item" onclick="location.href='{{ route('order-guide') }}'">ขั้นตอนการสั่งซื้อสินค้า</div>
    <div class="faq-item" onclick="location.href='{{ route('faq') }}'">คำถามที่พบบ่อย (FAQ)</div>
