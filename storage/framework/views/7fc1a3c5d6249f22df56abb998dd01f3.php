<?php $__env->startSection('title', 'ขอใบเสนอราคา - ข้อมูลใบกำกับภาษี'); ?>
...
<div class="container py-5">
    ...
    <form action="<?php echo e(route('quotation.confirm')); ?>" method="POST" id="taxInfoForm" novalidate>
        <?php echo csrf_field(); ?>
        ...
        <div class="d-flex mb-4">
            <label class="person-type-label"><input type="radio" name="tax_person_type" value="individual" class="person-type-radio" checked><span>บุคคลธรรมดา</span></label>
            <label class="person-type-label"><input type="radio" name="tax_person_type" value="juristic" class="person-type-radio"><span>นิติบุคคล</span></label>
        </div>
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-4"><label class="form-label">เลขที่</label><input type="text" name="tax_address_no" class="form-control"></div>
            <div class="col-md-4"><label class="form-label">ชื่ออาคาร</label><input type="text" name="tax_building" class="form-control"></div>
        ...
        <div class="d-flex justify-content-between align-items-center mt-5">
            <a href="<?php echo e(route('quotation.index')); ?>" class="btn btn-back">ย้อนกลับ</a>
...
<script>
    ...
    function preSubmitCheck() {
        ...
        // 🔥 ดึงชื่อสถานที่ภาษาไทยมาใส่ใน Hidden Input ก่อน Submit 🔥
        ...
        if (isValid) {
            Swal.fire({
                ...
                html: `<div class="mb-3"><img src="<?php echo e(asset('images/Hotmobilyfile/poster/robot-bill.png')); ?>" style="width: 150px; margin-bottom: 15px;"></div><p class="text-muted" style="font-size: 14px;">ใบเสนอราคานี้จัดทำโดยระบบอัตโนมัติเพื่อเป็นการอ้างอิงราคาเบื้องต้นเท่านั้น</p>`,
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        axios.get('<?php echo e(asset("province_with_district_and_sub_district.json")); ?>').then(response => { allData = response.data; populateProvinces(); });
        ...
        document.getElementById('sub_district').addEventListener('addItem', function(event) {
            const zip = event.detail.customProperties.zip; if (zip) zipcodeInput.value = zip;
        });
    });
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Hotmobily\hotmobily\resources\views/quotation/tax_info.blade.php ENDPATH**/ ?>