...
<?php $__env->startSection('title', 'วิธีการชำระเงิน - Hotstrap'); ?>

<?php $__env->startSection('content'); ?>

<link rel="stylesheet" href="<?php echo e(asset('css/payment-method.css')); ?>">
    ...
    <div class="container">
                ...
                <div class="card-body">
                    <div class="payment-method-section">
                        ...
                        <div class="bank-banner-wrapper">
                            <picture>
                                <source srcset="<?php echo e(asset('images/scb-mobile.png')); ?>" media="(max-width: 768px)">
                                <img src="<?php echo e(asset('images/scb-logo.png')); ?>" alt="SCB Payment Info" class="bank-banner-img">
                            </picture>
            ...
            <div class="info-card" id="section3">
                ...
                <div class="card-body">
                    <div class="production-banner-wrapper mb-4">
                        <img src="<?php echo e(asset('images/timeline.png')); ?>" alt="ระยะเวลาการผลิต" class="bank-banner-img">
                    </div>
        ...
        <div class="related-nav">
            <div class="nav-links-container">
                <a href="<?php echo e(route('order-guide')); ?>" class="nav-link-item">
                    <span>ขั้นตอนการสั่งซื้อสินค้า</span>
                </a>
                <a href="<?php echo e(route('faq')); ?>" class="nav-link-item">
                    <span>คำถามที่พบบ่อย (FAQ)</span>
                </a>
                <a href="<?php echo e(route('design-guide')); ?>" class="nav-link-item">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\project\hotmobily\resources\views/payment-method.blade.php ENDPATH**/ ?>