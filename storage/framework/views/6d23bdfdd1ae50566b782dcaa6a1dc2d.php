...
<div class="container py-5">
    ...
    <?php else: ?>
        ...
        <div class="empty-cart-container text-center py-5">
            <img src="<?php echo e(asset('images/Hotmobilyfile/poster/cart1.png')); ?>" alt="Empty Cart" class="empty-cart-icon mb-4" style="max-width: 150px;">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Hotmobily\hotmobily\resources\views/cart.blade.php ENDPATH**/ ?>