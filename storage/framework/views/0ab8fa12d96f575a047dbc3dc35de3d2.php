  ...
  <h4 class="payment-title">บัญชีชำระเงิน</h4>
        <div class="payment-box">
          <picture>
            ...
            <img src="<?php echo e(asset('images/scb-logo.png')); ?>" alt="SCB Logo Banner" class="bank-img">
          </picture>
          <button id="copyBtn" class="copy-btn-overlay">คัดลอก</button>
        </div>
      </div>
    </div>
  </div>
...
<div class="faq-section">
  ...
  <div class="faq-item" onclick="location.href='<?php echo e(route('faq')); ?>#faq'">
    คำถามที่พบบ่อย (FAQ)
  </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\project\hotmobily\resources\views/order-guide.blade.php ENDPATH**/ ?>